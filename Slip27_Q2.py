...
print("SLR Level 11:", slr.predict([[11]])[0])
print("SLR Level 12:", slr.predict([[12]])[0])

print("PLR Level 11:", plr.predict(poly.transform([[11]]))[0])
print("PLR Level 12:", plr.predict(poly.transform([[12]]))[0])
